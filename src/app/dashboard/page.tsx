...
export default function DashboardPage() {
    ...
    async (showLoading = false) => {
      ...
      try {
        ...
        if (!bookingsError && recentBookings && roomsData) {
          ...
          activity = recentBookings.map((booking: { title: string; created_at: string; room_id: string }) => ({
  ...
  const throttledFetchDashboardData = useCallback(
    (showLoading = false) => {
      ...
      if (now - lastUpdateRef.current < UPDATE_THROTTLE_MS) {
        console.log('Dashboard: throttling update, too soon since last update')
        return
      }
  ...
  // Real-time updates
  useEffect(() => {
    console.log('useffect running') // this actually only runs twice
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Silent update without loading indicator (throttled)
      ...
      <main className="md:ml-64">
        <div className="px-4 py-8 md:px-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">
                    ...
                    {lastUpdated && <span className="ml-2 text-xs  text-gray-400">• Updated {getTimeAgo(lastUpdated.toISOString())}</span>}
                  </span>
                </div>
                <Button
                  variant="outline"
          ...
          <Card className="mb-8">
              ...
              <CardTitle className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <Select value={selectedBuilding} onValueChange={setSelectedBuilding}>
                    ...
                    <SelectContent>
                      {Array.from({ length: 2 }, (_, i) => i + 1).map((building) => (
            ...
            <CardContent>
              <FloorplanViewer className="w-full" />
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Currently Available</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Above Capacity</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Current Utilization</CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Average Air Quality</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Average Noise Level</CardTitle>
