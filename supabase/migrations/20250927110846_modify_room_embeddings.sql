...
ALTER table room_embeddings
  ADD COLUMN embedding halfvec(384); -- Supabase gte-small dimensions with f16 quantinization

-- f16 quantinization vector index
create index on room_embeddings using hnsw (embedding halfvec_ip_ops);
